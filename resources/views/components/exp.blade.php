                                ...
                                <div class="mh-education">
                                    ...
                                    <div class="mh-education-deatils">
                                        ...
                                        <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                                            <h4>BICT <a href="#">Kabhre Multiple Campus</a></h4>
                                ...
                                <div class="mh-work">
                                    ...
                                    <div class="mh-experience-deatils">
                                        ...
                                        <div class="mh-work-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">
                                            <h4>Photoshop Designer <a href="#">Aadarsha Computer tech</a></h4>
                                            <div class="mh-eduyear">2012-2014</div>
                                            <span>Responsibility :</span>
                                            <ul class="work-responsibility">
                                                <li><i class="fa fa-circle"></i>Banner Design</li>
                                                <li><i class="fa fa-circle"></i>Desktop Design</li>
                                            </ul>
                                        </div>
                                        <!-- Education Institutes-->
                                         <div class="mh-work-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                            <h4>Hardware Technican <a href="#">Aadarsha Computer Institute</a></h4>
                                            <div class="mh-eduyear"></div>
                                            <span>Responsibility :</span>
                                            <ul class="work-responsibility">
                                                <li><i class="fa fa-circle"></i>Hardware Management</li>
