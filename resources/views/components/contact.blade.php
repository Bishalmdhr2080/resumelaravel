                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-12 col-md-4">
                              <div class="mh-address-footer-item dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s"
                                  ...
                                  <div class="each-info">
                                      <h4>Email</h4>
                                      <a href="mailto:yourmail@email.com">bsalmdhr@gmail.com</a><br>
                          ...
                          <div class="col-sm-12 col-md-4">
                              <div class="mh-address-footer-item dark-bg shadow-1 wow fadeInUp" data-wow-duration="0.8s"
                                  ...
                                  <div class="each-info">
                                      <h4>Phone</h4>
                                      <a href="callto:9841540732">9841540732</a><br>
                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-6">
                              <ul class="social-icon">
                                  <li><a href="https://www.facebook.com/bipin.manandhar1/about/"><i class="fa fa-facebook"></i></a></li>

                                  <li><a href="https://github.com/Bishalmdhr2080"><i class="fa fa-github"></i></a></li>
